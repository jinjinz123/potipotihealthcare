        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-6">
            ...
            <div className="space-y-2.5">
              ...
              <div className={`rounded-xl border p-4 space-y-2 text-xs leading-relaxed font-sans ${
                displayMode === 'dark' ? 'bg-[#1c1b1f] border-[#49454F] text-slate-350' : 'bg-white border-gray-150 text-slate-650'
              }`}>
                <p className="font-semibold">
                  ポチログは、睡眠記録とメンタル記録を統合し、自己管理をサポートするWebアプリです。すべてのデータはご使用のブラウザ（ローカルストレージ）にのみ安全に保存され、外部サーバーに送信されることはありません。
                </p>
              </div>
            </div>
